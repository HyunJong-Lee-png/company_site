...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Header */}
      <header className="relative w-full h-64 bg-cover bg-center flex justify-between items-center px-6" style={{ backgroundImage: "url('/ship2.jpg')", backgroundSize: 'contain' }}>
